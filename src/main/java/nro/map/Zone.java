...
//                                if (percentDropKichHoat < 5 && map.MapSetKichHoat()) { //ITEM ROT LA ITEM KICH HOAT
                                if (percentDropKichHoat < 50 && map.MapSetKichHoat()) { //ITEM ROT LA ITEM KICH HOAT
                                    ...
                                    int optionItemKichHoat[][] = {{127, 128, 129, 139, 140, 141}, {130, 131, 132, 213, 142, 143, 144, 214}, {133, 134, 135, 136, 137, 138}};
...
//                                itemROI.itemTemplateID = (short)itemROI.itemMapID;
                                    ...
                                    if(p.gender == (byte)1) {
                                        _ITEMKICHHOAT.itemOptions.add(new ItemOption(optionItemKichHoat[(int) p.gender][rdOptionKichHoat + 4], 0));
                                    } else {
